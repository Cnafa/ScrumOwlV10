...
// FIX: Imported WORKFLOW_RULES to resolve 'Cannot find name' error on line 287.
...
export const WorkItemEditor: React.FC<WorkItemEditorProps> = ({ workItem, epics, teams, sprints, onSave, onCancel, isNew, highlightSection, boardUsers }) => {
  ...
  const handleDescriptionChange = (editor: Editor) => {
    setLocalWorkItem(prev => ({
        ...prev, 
        description: editor.getText(), // For compatibility
        description_rich: editor.getJSON(), // The rich content
    }));
  };
